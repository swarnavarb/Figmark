...
## Corpus Check
- 248 files · ~429,095 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2262 nodes · 6385 edges · 69 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 1789 · calls: 1605 · imports: 1160 · MODIFIES: 614 · imports_from: 510 · ON_BRANCH: 339 · method: 251 · PARENT_OF: 73 · inherits: 23 · re_exports: 10 · implements: 7 · rationale_for: 4
...
- Excluded: 15 untracked · 17617 ignored · 2 sensitive · 14 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `d177e95`
...
- `0326170 Maintenance ran in front of every request, on every cold worker` --ON_BRANCH--> `development`  [EXTRACTED]
  git → git  _Bridges community 15 → community 46_
...
- `21a509d Resume Route Builder: mobile-first stage boxes over the existing route model` --ON_BRANCH--> `feature/route-builder-stages`  [EXTRACTED]
  git → git  _Bridges community 10 → community 15_
- `29bd178 The Functions host keeps /admin for itself, so those eight routes never existed` --ON_BRANCH--> `chore/azure-swa-development-env`  [EXTRACTED]
  git → git  _Bridges community 40 → community 15_
...
Cohesion: 0.03
Nodes (71): ALLOWED_TYPES, anon, assignOrderToLotRoute, deleteTemplateRoute, listTemplatesRoute, photoRoute, saveTemplateRoute, TemplateBody (+63 more)
...
Cohesion: 0.06
Nodes (8): Drill, DRILL_HINTS, ESCROW_WORDS, OrderFilter, PAYMENT_WORDS, Section, SECTION_GROUPS, SECTIONS
...
Cohesion: 0.21
Nodes (12): development, 06db1c6 Stop tracking graphify local/machine state, 31569c8 Remove unsupported production_branch input from Azure SWA deploy steps, 320bbe5 A members' window that actually withholds something, and one place for batches, 3ca4812 Add stable development deployment to Azure Static Web Apps workflow, 87cac97 Remove unsupported production_branch input from Azure SWA deploy steps, 904cac6 Fix the powerSales indexing path, and check the rest of them, 9bd6ac1 Add graphify local-state files to .gitignore (+4 more)
...
Cohesion: 0.15
Nodes (5): LOT_SECTIONS, LotDetail(), LotSection, NewLotForm(), summarise()
...
Cohesion: 0.33
Nodes (2): RouteEditor(), RoutesList()
...
Cohesion: 1.00
Nodes (2): OrderRow(), orderTone()

## Knowledge Gaps
- **350 isolated node(s):** `Section`, `SECTIONS`, `SECTION_GROUPS`, `OrderFilter`, `PAYMENT_WORDS` (+345 more)
...
- **Thin community `Community 45`** (1 nodes): `isNotFound()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `AuthError`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (2 nodes): `css`, `parsed`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (2 nodes): `RouteEditor()`, `RoutesList()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `isConflict()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `catalogOrder()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (2 nodes): `OrderRow()`, `orderTone()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `CosmosRepository` connect `Community 5` to `Community 3`, `Community 45`, `Community 44`, `Community 68`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 16`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `MemoryRepository` connect `Community 1` to `Community 16`, `Community 3`, `Community 55`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `AuthError` connect `Community 52` to `Community 4`, `Community 34`, `Community 6`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **What connects `Section`, `SECTIONS`, `SECTION_GROUPS` to the rest of the system?**
